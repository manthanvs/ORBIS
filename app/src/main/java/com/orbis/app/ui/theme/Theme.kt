...
/**
 * @param dynamicColor off by default. Material You would repaint ORBIS in the
 *   user's wallpaper colours, which can land anywhere - including reds that make
 *   an encouraging dashboard look like a warning. The palette is part of the
 *   design here, so it is not handed over to the wallpaper.
 */
@Composable
fun OrbisTheme(
